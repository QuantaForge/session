...
use QuantaForge\Session\SessionManager;
...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \QuantaForge\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \QuantaForge\Session\SessionManager  $manager
    ...
    protected function handleStatefulRequest(Request $request, $session, Closure $next)
    {
        ...
        // so that the data is ready for an application. Note that the QuantaForge sessions
        // do not make use of PHP "native" sessions in any way since they are crappy.
        $request->setQuantaForgeSession(
     ...
     *
     * @param  string  $driver
     * @return \QuantaForge\Cache\Store
     */
